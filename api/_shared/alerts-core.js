...
const ALERT_FROM = () => (process.env.ALERT_FROM || 'Lifecycle OS <alerts@knickgasm.com>');
...
<table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;background:#fff;border:1px solid #ece4d2;border-radius:10px;overflow:hidden">
  <tr><td style="background:#D0473E;color:#FFFFFF;padding:18px 22px;font-family:'Montserrat',Georgia,serif;font-size:18px">Lifecycle OS · ${esc(title)}</td></tr>

 ...
 * window.KNICKGASM_ANALYTICS. The Data Analysis dashboard (data-analysis.html)
...
fs.writeFileSync(OUT, banner + 'window.KNICKGASM_ANALYTICS = ' + JSON.stringify(payload) + ';\n');

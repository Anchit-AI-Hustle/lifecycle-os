...
LIMIT 6""",
  ...
  },
  {
    ...
    "insights": [
      ...
      ("SKU-Driven Time Variation", "Loose-panel 100g packs drive repurchase at median 38 days (pack consumption rate). Teabag formats drive repurchase at median 28 days. Gift sets drive repurchase at median 82 days (gifter mentality, not personal consumption). SKU mix on first order explains most of the variance."),

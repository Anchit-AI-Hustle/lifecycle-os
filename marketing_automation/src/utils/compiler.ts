...
<head>
  ...
  <style>
    ...
    * {
    ...
    .font-serif {
      font-family: "Montserrat", "Raleway", Georgia, serif;
    }
...
<body>
  ...
  <footer style="background-color: var(--color-brand); color: var(--color-chalk); padding: 3rem 0; text-align: center;">
    <div class="container container-sm">
      ...
      <p class="text-xs text-gray-400 mt-6 font-mono" style="opacity: 0.6;">&copy; 2026 Knickgasm India. All Rights Reserved.</p>
    </div>
  </footer>

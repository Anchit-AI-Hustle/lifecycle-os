...
argument-hint: "[product + offer + audience, e.g. 'sleep sneaker, 10% first order, stressed professionals']"
---
...
- Angles: Feeling/end-state · Ritual/moment · Origin/craft (one-of-one, hand-painted) · Proof/specific detail · Contrast (vs coffee crash, vs stale supermarket sneaker).
- Awareness: Unaware (story-first) · Problem-aware (name the pain) · Solution-aware (why sneaker, why this form) · Product-aware (offer-forward).
